      ...
      <div className=" bg-white flex    flex-col ">
        <div className="">
          <div className="flex flex-col py-5 items-center">
            ...
            <h2 className="text-[35px] font-bold text-[#ffc800] tracking-wide">
              gurantee your success
            </h2>
          </div>
          <div className="">
            <div className="relative  min-h-[75vh]">
              <div className="w-10/12  border-[1px] border-slate-200 mx-auto  p-5 text-header shadow bg-[#f1f0f097]  rounded-md">
                <h2 className=" tex-[14px] p-10 text-normal font-normal tracking-wider leading-7 font-serif  ">
                ...
                <div className="absolute top-[35%] left-[10%] w-10/12">
        ...
        <div className="">
          <div className=" flex flex-col mt-10   pt-20 items-center">
            <h2 className="text-[35px] font-bold text-header tracking-wide">
              We're here for you
            </h2>
            <h2 className="text-[35px] font-bold text-[#ffc800] tracking-wide">
        ...
        <div className="w-10/12 py-2 mx-auto">
          ...
          <div className=" flex py-2 flex-col ">
            <div className="flex">
              <h2 className=" w-3/12 text-header text-[18px] font-semibold">
                Unmatched service
              </h2>
              <h2 className="font-serif w-8/12 text-normal font-medium text-[16px]">
